...
final List<Flowers> listFlowers = <Flowers>[
  Flowers(
      image: Image.asset('assets/images/fea1.jpg'),
      name: 'Samantha',
      country: 'Russia',
      price: 400),
  Flowers(
      image: Image.asset('assets/images/fea2.jpg'),
      name: 'Angelica',
      country: 'Russia',
      price: 540),
  Flowers(
      image: Image.asset('assets/images/fea3.jpg'),
      name: 'Serena',
      country: 'Russia',
      price: 450),
];
...
class HomeScreenFeatured extends StatelessWidget {
  const HomeScreenFeatured({Key? key}) : super(key: key);
